            ...
            {todos.map(item => {
              return (showFinished || !item.isCompleted) && <div key={item.id} className="todo flex justify-between m-2 border border-black p-2 items-center rounded-xl bg-violet-500 hover:bg-violet-700 ">
                ...
                <div className="button ">
                  <button onClick={(e) => handleEdit(e, item.id)} className='border border-black bg-violet-600 hover:bg-violet-800  text-white mx-1 px-2 py-1 rounded-md text-2xl'><FaEdit />
                  </button>
                  <button onClick={(e) => handleDelete(e, item.id)} className='border border-black bg-violet-600 hover:bg-violet-800  text-white mx-1 px-2 py-1 rounded-md text-2xl'><MdDelete />
                  </button>
                </div>
              </div>
            })}
